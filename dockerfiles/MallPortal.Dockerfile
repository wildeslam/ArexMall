...
ENV JAVA_TOOL_OPTIONS="-javaagent:/usr/local/tomcat/arex-agent.jar -Darex.service.name=Arex-Mall -Darex.storage.service.host=10.118.1.217:8093 -Darex.enable.debug=true"
EXPOSE 8084
